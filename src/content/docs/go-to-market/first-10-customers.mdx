...
description: "How to get the first 10 paying customers with zero paid ads and zero sales team — weeks 1 through 8."
---
...
```mermaid
graph TD
    A["Personal Network<br/>Customers 1-3"] --> B["Indie Hackers + r/SaaS<br/>Customers 4-7"]
    B --> C["SaaS Twitter/X<br/>Customers 8-10"]
    A -.->|"Lifetime 50% discount<br/>for detailed feedback"| A
    B -.->|"Brutally honest post<br/>+ first month free"| B
    C -.->|"Daily insights threads<br/>+ natural product links"| C
