...
description: "The hyper-specific ICP for Spear: technical B2B SaaS founders at $0-2M ARR who need pipeline but hate doing outbound."
---
...
```mermaid
graph TD
    A[All B2B Companies] --> B[B2B SaaS Only]
    B --> C[1-15 Employees]
    C --> D["$0-2M ARR"]
    D --> E[Technical Founder/Co-founder]
    E --> F[Has Working Product]
    F --> G[English-Speaking Markets]
    G --> H["🎯 Spear's ICP<br/>~50,000-100,000 companies"]
