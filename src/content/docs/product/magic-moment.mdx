...
description: "The 'aha' experience: from signup to first meeting booked, with zero sales expertise required."
---

import { Card, Badge, Steps } from '@astrojs/starlight/components';

Every great product has a moment where the user thinks "okay, this is real." For Spear, that moment is when a meeting shows up on your calendar from a prospect you didn't find, didn't email, and didn't chase — and they're a perfect fit.
...
```mermaid
graph TD
    A["🔗 Sign Up<br/>Connect Google account"] --> B["📝 Paste Product URL<br/>+ describe ideal customer in 2 sentences"]
    B --> C["📧 Connect Email<br/>Gmail/Outlook OAuth"]
    C --> D["⏳ Wait 4 Hours<br/>AI researches prospects"]
    D --> E["👀 Review 25 Prospects<br/>With draft outreach ready"]
    E --> F["✅ Approve 10 with One Click<br/>Edit any you want"]
    F --> G["📤 First Emails Sent<br/>Next morning, respecting deliverability"]
    G --> H["💬 First Reply<br/>Within days"]
    H --> I["📅 First Meeting Booked<br/>Within 2 weeks"]
